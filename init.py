...
def addValues(folderOutput):
    ...
    for i in folderOutput["metadata"]:
        ...
        print(i["match_id"])
        cursor.execute("""INSERT INTO matches VALUES ('{}', '{}', '{}', '{}', '{}');""".format(i["match_id"], i["date"], i["year"], i["number"], i["winner"]))
    ...
    for i in folderOutput["teamMatches"]:
        ...
        cursor.execute("""INSERT INTO teamMatches VALUES ('{}', '{}', '{}', '{}', {}, {}, {}, {}, '{}', '{}', '{}', '{}', '{}', '{}')"""
                       .format(i["team_match_id"], i["match_id"], i["year"], i["team"], 1 if i["win"] else 0, i["total_bat"], i["total_cede"], i["total_wickets"],
                               json.dumps(i["overs_bat"]), json.dumps(i["overs_cede"]), json.dumps(i["overs_wickets"]), json.dumps(i["balls_bat"]), json.dumps(i["balls_cede"]), json.dumps(i["balls_wickets"])))
